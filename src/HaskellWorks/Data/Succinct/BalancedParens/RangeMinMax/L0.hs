...
instance BalancedParens (RangeMinMaxL0 (DVS.Vector Word64)) where
  openAt            = openAt      . rangeMinMaxL0BP
  closeAt           = closeAt     . rangeMinMaxL0BP
