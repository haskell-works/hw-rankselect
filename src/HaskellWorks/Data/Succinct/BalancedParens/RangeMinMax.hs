...
mkRangeMinMax bp = RangeMinMax
  ...
  , rangeMinMaxL2Excess = DVS.constructN lenL2 (\v -> let (_, e,    _) = allMinMaxL2 DV.! DVS.length v in fromIntegral e)
  }
...
rangeMinMaxFindCloseNL2 :: RangeMinMax -> Int -> Count -> Maybe Count
