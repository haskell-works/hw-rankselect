...
findCloseN' :: RangeMinMax -> Int -> Count -> Result Count
...
rangeMinMaxFindCloseN :: RangeMinMax -> Int -> Count -> Result Count
...
rangeMinMaxFindCloseNL0 :: RangeMinMax -> Int -> Count -> Result Count
...
rangeMinMaxFindCloseNL1 :: RangeMinMax -> Int -> Count -> Result Count
...
rangeMinMaxFindCloseNL2 :: RangeMinMax -> Int -> Count -> Result Count
